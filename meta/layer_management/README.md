...
This is especially true for near layers such as `fragments / playbook` and `core / theory`, where linking as background principle, implementation means, and practical instance is often more natural than forced vertical movement.
...
## Watch targets (your own)

This is where you list the files you are currently keeping an eye on for a
possible layer move — a fragment maturing toward theory, a playbook item drifting
toward context, an essay that should stay tightly scoped. It starts empty; fill
it with your own instances as they arise.

## References

- `meta/update/protocol.md`
- `meta/layer_management/frontmatter_samples.md`
- `core/README.md`
- `context/README.md`
- `theory/README.md`
- `playbook/README.md`
